...
public class korea extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener{
    ...
    int index=0;
    int gorseller[]= {R.mipmap.k1, R.mipmap.k2, R.mipmap.k3, R.mipmap.k4, R.mipmap.k5};
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()){
            case R.id.nav_home:
                ...
                break;
            case R.id.nav_url:
                Intent intent2 = new Intent(korea.this, wiseweb.class);
